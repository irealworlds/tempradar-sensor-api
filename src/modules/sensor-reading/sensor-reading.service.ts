...
export class SensorReadingService {
   ...
   * @return {Promise<SensorReading[]>} A promise that resolves with an array of sensor readings.
   */
  public async fetchAllForSensor(sensor: Sensor): Promise<SensorReading[]> {
   ...
   * @returns {Promise<SensorReading>} - A promise that resolves to the created SensorReading object.
   */
